...
const OurUniverse = () => {
  return (
    ...
    <p className="px-10 leading-10 text-center">Découvrez en images l’univers de Cultivon’sport ! Nos activités allient mouvement, réflexion et plaisir, accessibles à tous, que vous soyez enfant, adulte ou en quête d’un team-building original. Plongez dans l’action !</p>
